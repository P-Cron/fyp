...
def testStore():
    ...
    profileAccord = vehicleProfile.VehicleProfile('08KY10099', logFilesAsDfs.accord9)
    # profileGolf = vehicleProfile.VehicleProfile('07D22551', logFilesAsDfs.golf2)
    profileGolf = vehicleProfile.VehicleProfile('07D22551', logFilesAsDfs.golf3)
